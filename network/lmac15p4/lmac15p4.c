...
static SemaphoreHandle_t xSemaphore_tx = NULL;
static StaticSemaphore_t xSemaphoreBuffer;
static StaticSemaphore_t xSemaphoreBuffer_tx;
...
int lmac15p4_init(lmac15p4_modem_t modem, uint8_t band_type) {
    ...
    xSemaphore_tx = xSemaphoreCreateBinaryStatic(&xSemaphoreBuffer_tx);

    xSemaphoreGive(xSemaphore);
    xSemaphoreGive(xSemaphore_tx);
    configASSERT(xSemaphore);
    configASSERT(xSemaphore_tx);
    return 0;
}
