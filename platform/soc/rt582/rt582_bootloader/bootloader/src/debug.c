...
char* cvt(double arg, int ndigits, int* decpt, int* sign, char* buf,
          int eflag) {
    int r2;
    double fi, fj;
    char *p, *p1;
        ...
        switch (state) {
            ...
            case st_flags:
                switch (ch) {
                    ...
                    case '\'': flags |= FL_TICK; break;
                    case ' ': flags |= FL_SPACE; break;
                    case '#': flags |= FL_HASH; break;
            ...
            case st_modifiers:
                switch (ch) {
                    ...
                    case 'l':
                        rank++; /* Longer rank */
                        break;
                    case 'j': rank = INTMAX_RANK; break;
                    case 'z': rank = SIZE_T_RANK; break;
                    case 't': rank = PTRDIFF_T_RANK; break;
                    case 'L':
                    case 'q': rank += 2; break;
                    default:
                        ...
                        switch (ch) {
						   ...
						   needed... */
                                ...
                                goto is_integer;
                            case 'o': /* Octal */ base = 8; goto is_unsigned;
                            ...
                            is_unsigned:
                                switch (rank) {
                                    case rank_char:
                                        val = (uintmax_t)(unsigned char)va_arg(
                                            ap, unsigned int);
                                        break;
                                    case rank_short:
                                        val = (uintmax_t)(unsigned short)va_arg(
                                            ap, unsigned int);
                                        break;
                                    case rank_int:
						   ...
						   characters written */
                            ...
                            case 'f': {
                                tmp = q;
                                q = flt(q, va_arg(ap, double), width, prec, ch,
                                        SIGN);
                                o += q - tmp;
                                continue;
                            }
...
void debug_print(uint8_t* data, uint32_t len) { uart_stdio_write(data, len); }
...
void vMainUARTPrintString(char* pcString) { puts(pcString); }
